...
@router.get('/profile/') # TODO: edit response to template
async def profile(
    request: Request,
    user_id: int = Depends(get_current_user_id) 
):
    if user_id:
        response = ... # authorized page
    response = ... # unauthorized page
    return response


@router.get('/question/{question_id}/') # TODO: edit response to template
async def question(
    question_id: int,
    request: Request,
    question_service: QuestionsService = Depends(get_questions_service),
    ...
    if user_id:
        return question # authorized page
    return question # unauthorized page


@router.post('/question/') # TODO: edit response to template
async def question(
...
@router.post('/question/{question_id}/answer') # TODO: edit response to template
...
@router.get('/auth/telegram/') # TODO: edit response to redirect
